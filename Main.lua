...
local Tabs = {
    ...
    Race = Window:AddTab({ Title = "Auto Trial V4", Icon = "" }),
    Raid = Window:AddTab({ Title = "Auto Raid", Icon = "" }),
    Melee = Window:AddTab({ Title = "Cửa Hàng", Icon = "" })
    meowx = Window:AddTab({ Title = "Setting", Icon = "" }),
}
...
local LinhTinh = Tabs.meowx:AddSection("Main Setting Config")
local Toggle = Tabs.meowx:AddToggle("Turn V4", { Title = "Tự Động Bật V4", Default = true })
Toggle:OnChanged(function(Value)
    RaceNguLon = Value
end)
...
local Toggle = Tabs.meowx:AddToggle("Tự Động Spawn Katakuri", { Title = "Tự Động Spawn Katakuti", Default = true })
Toggle:OnChanged(function(Value)
...
local Toggle = Tabs.meowx:AddToggle("Đi Trên Nước", { Title = "Đi Trên Nước", Default = true })
Toggle:OnChanged(function(Value)
    _G.NuocLon = Value
end)
...
local Toggle = Tabs.meowx:AddToggle("Walk Water", { Title = "Auto Rejoin", Description = "Rejoin When Kick", Default = true })
Toggle:OnChanged(function(Value)
    _G.Rejoin = Value
end)                          
...
local Toggle = Tabs.meowx:AddToggle("RemoveConMe", { Title = "Xoá Thông Báo", Description = "Xoá Thông Báo Khi Những Gì Bạn Farm", Default = false })
