...
local Toggle = Tabs.meo:AddToggle("Teleport Gear", { Title = "Auto Nhìn Trăng", Default = false })
Toggle:OnChanged(function(Value)
...
local Toggle = Tabs.meo:AddToggle("Teleport Gear", { Title = "Auto Bay Đến Gear", Default = false })
Toggle:OnChanged(function(Value)
    _G.Luom_Gear = Value
...
local Toggle = Tabs.Race:AddToggle("Turn V4", { Title = "Auto Bật Tộc V4", Default = true })
Toggle:OnChanged(function(Value)
    RaceNguLon = Value
end)
